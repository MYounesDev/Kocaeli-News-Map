"""
Scraper for cagdaskocaeli.com.tr

Uses the archive page /arsiv/{YYYY-MM-DD} which lists all articles for a given date.
Each div.f-cat.f-item contains a category (h3) and list of article links (ul > li > a).
"""
...
class CagdasKocaeliScraper(BaseScraper):
    ...
    def source_name(self) -> str:
        return "cagdaskocaeli"

    @property
    def base_url(self) -> str:
        return "https://www.cagdaskocaeli.com.tr"
    ...
    def _parse_archive_page(self, html: str, date: datetime) -> list[RawArticle]:
        """Parse an archive page and extract article links with categories."""
